  ...
  priv_node_handle_(private_nh)
{
  ...
  ************************************************************/
  port_name_ = priv_node_handle_.param<std::string>("usb_port", "/dev/ttyUSB1");
...
void HardwareInterface::registerControlInterfaces()
{
  ...
  hardware_interface::JointStateHandle dummy_state_handle2("arm2_virtual_yaw_joint", &dummy_pos_[0], &dummy_vel_[0], &dummy_eff_[0]);
  ...
  hardware_interface::JointHandle dummy_pos_handle2(joint_state_interface_.getHandle("arm2_virtual_yaw_joint"), &dummy_cmd_[0]);
