  ...
  priv_node_handle_(private_nh)
{
  ...
  ************************************************************/
  ...
  baud_rate_ = priv_node_handle_.param<int32_t>("baud_rate", 115200);
...
void HardwareInterface::registerControlInterfaces()
{
  ...
  hardware_interface::JointStateHandle dummy_state_handle2("virtual_yaw_joint", &dummy_pos_[0], &dummy_vel_[0], &dummy_eff_[0]);
  joint_state_interface_.registerHandle(dummy_state_handle2);

  // hardware_interface::JointStateHandle state_handle7("joint7", &pos_[2], &vel_[2], &eff_[2]);
  // joint_state_interface_.registerHandle(state_handle7);



  hardware_interface::JointHandle dummy_pos_handle2(joint_state_interface_.getHandle("virtual_yaw_joint"), &dummy_cmd_[0]);
  position_joint_interface_.registerHandle(dummy_pos_handle2);
  
      hardware_interface::JointHandle dummy_effort_handle2(joint_state_interface_.getHandle("virtual_yaw_joint"), &dummy_cmd_[0]);
    effort_joint_interface_.registerHandle(dummy_effort_handle2);
